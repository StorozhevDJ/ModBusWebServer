...
public class MLPDeviceModbusMapper {
	...
	public static short modbusMapOffsetSetting = (short) (DeviceInfoModbusMapMapper.getDeviceInfoMapSize() + 22);
	 ...
	 */
	public void ParseRegisterData(Register[] slaveResponse) {
		...
		angle_AX = slaveResponse[modBusDataRegMap.Angle_AX.ordinal()].toShort();
		angle_AY = slaveResponse[modBusDataRegMap.Angle_AY.ordinal()].toShort();
		angle_AZ = slaveResponse[modBusDataRegMap.Angle_AZ.ordinal()].toShort();
		accel = slaveResponse[modBusDataRegMap.Accel.ordinal()].toShort();

		angle_MX = slaveResponse[modBusDataRegMap.Angle_MX.ordinal()].toShort();
		angle_MY = slaveResponse[modBusDataRegMap.Angle_MY.ordinal()].toShort();
		angle_MZ = slaveResponse[modBusDataRegMap.Angle_MZ.ordinal()].toShort();

		tempCase = slaveResponse[modBusDataRegMap.TempCase.ordinal()].toShort();
		tempAccel = slaveResponse[modBusDataRegMap.TempAccel.ordinal()].toShort();
	 ...
	 * 
	 * // FirmWare UpDate private short BLPass; private short BLCMD; private short
	 * BLPtrH; private short BLPtrL; private Short[] BLData = new Short[8];
	 */
	
	
	public MLPData mapMLPData(Register[] regs) {
		ParseRegisterData(regs);
		MLPData dev = new MLPData();
